...
# ==================================================
# Link Hosting Kalian
HendraWahyut="raw.githubusercontent.com/WaanStore/AutoUp/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/WaanStore/AutoUp/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/WaanStore/AutoUp/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/WaanStore/AutoUp/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
